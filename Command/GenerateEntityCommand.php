...
class GenerateEntityCommand extends ContainerAwareCommand
{
    ...
    protected function configure()
    {
        $this
            ...
            ->setDescription('Generate an entity using a table schema')
        ;
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if ($source) {
            ...
            $command = sprintf("bin/console goat:generate-entity --source=%s %s %s", $source, $module, $table);
...
EOT;
         ...
         **********************************************************************/
            ...
            if ($nullable) {
                ...
                $returnStatement = ' : ' . $getterReturnType;
            }
...
EOT;
     ...
     */
    public function {$getterPrefix}{$camelCasedName}(){$returnStatement}
    {
{$getterBody}
    }
EOT;
